                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            id="filter-select-outer-ages",
                            children=[
                                html.Div(
                                    children=[
                                        html.Label("Filter by language"),
                                        dcc.Dropdown(
                                            id="language-select-ages",
                ...
                html.Div(
                    ...
                    children=[
                        html.Div(
                            id="table-ages",
                            children=[
                                dcc.Graph(id="ages-plot-1"),
                                dcc.Graph(id="ages-plot-2")
                            ],
                        ),
                    ],
                ),
