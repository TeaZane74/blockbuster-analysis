                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                ...
                                dcc.Dropdown(
                                    id="metric-select",
                                    options=[{"label": i, "value": i} for i in ['BoxOfficeDollars', 'BudgetDollars', 'OscarNominations', 'OscarWins', 'Benefits']],
                                    value=['BoxOfficeDollars', 'BudgetDollars', 'OscarNominations', 'OscarWins', 'Benefits'][0],
                                ),
                            ],
                        ),
                        html.Br(),
